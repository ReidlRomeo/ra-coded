...
/** Route for the Identity Manager Role Analysis surface. */
export const IDENTITY_ROLE_ANALYSIS_ROUTE = '#/identity/role-analysis';

/** Standalone Role Analysis item, shown directly below Insights (always visible). */
export const IDENTITY_ROLE_ANALYSIS_ITEM: VerticalNavEntry = {
  value: 'role-analysis',
  label: 'Role Analysis',
  icon: 'ChartLine',
  route: IDENTITY_ROLE_ANALYSIS_ROUTE,
};
